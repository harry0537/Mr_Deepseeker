...
python scripts/run_review.py review /path/to/project

# Review with extra focus
python scripts/run_review.py review /path/to/project "focus on Kelly sizing bugs"

# Review all from registry
python scripts/run_review.py review-all examples/custom_registry.json

# Raw JSON output
python scripts/run_review.py json /path/to/project
```
